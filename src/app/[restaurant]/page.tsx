...
const navItems = [
	{ label: 'اکسپلور', value: 'explore', icon: 'f015' },
	{ label: 'منو', value: 'menu', icon: 'e3e3' },
	{ label: 'پشتیبانی', value: 'reviews', icon: 'f4ad' },
	{ label: 'ارتباط با ما', value: 'contact', icon: 'f8d3' },
	{ label: 'خروج', value: 'signout', icon: 'f011' },
];
